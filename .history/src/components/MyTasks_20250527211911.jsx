...
import { supabase } from "../supabase"; // Make sure supabase is properly configured
...
function MyTasks() {
  ...
  useEffect(() => {
    const fetchUserAndTasks = async () => {
      ...
      // 2. Fetch tasks using a join on 'task_members' and 'tasks'
      ...
      const extractedTasks = tasksData
        .map((tm) => tm.tasks)
        .filter((t) => t !== null); // Filter out any nulls if relationships are missing
