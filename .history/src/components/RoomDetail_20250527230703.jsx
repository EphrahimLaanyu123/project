...
function RoomDetail() {
  ...
  useEffect(() => {
    ...
    async function fetchRoomMembers() {
      ...
      // Fetch the room creator's ID to include them in the members list
      ...
      // Add creator's ID if not already in the list of members
      ...
      // Combine room member data with user usernames and mark the creator
    ...
    fetchRoomDetails();
    fetchRoomMembers(); // Members are fetched on initial load
    fetchUser();
    fetchTasks();
