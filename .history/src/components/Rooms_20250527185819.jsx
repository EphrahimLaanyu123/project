  ...
  useEffect(() => {
    async function fetchUserAndRooms() {
      ...
      if (userError) {
        ...
        // Continue without username if there's an error, or set a default
        setUser((prevUser) => ({ ...prevUser, username: "Guest" }));
      } else {
        setUser((prevUser) => ({ ...prevUser, username: userData?.username || "Guest" }));
      }
